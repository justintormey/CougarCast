...
`github-actions-cougarcast-deploy` through GitHub **OIDC** (no static keys) and deploys to **s3://justintormey.com/cougarcast/**, then invalidates CloudFront `E1R27W2LA6BBEH`.
...
- **Do NOT** change the role trust (pinned to `repo:justintormey/CougarCast:ref:refs/heads/main`), its permission
