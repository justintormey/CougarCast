...
- "Dark text" checkbox on custom action editor rows — operators can now toggle black text on any custom action button (e.g. yellow button + black text), matching the behavior of preset actions like YELLOW CARD (issue #12)
